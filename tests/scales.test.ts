...
describe('utils:scales', () => {
    describe('offsetScale', () => {
        ...
        const SIMPLE: Scale = {type: ScaleType.Linear};
        const SIMPLE_10: Scale = {type: ScaleType.Linear, offset: 0.1};

        const SAMPLES: DSamples = {
            'simple line, 5% (default)': {
                '(50, 1000) -> (48, 1050)': [[50, 1000, SIMPLE, LINES], {min: 48, max: 1050}],
                '(0, 100) -> (0, 105)': [[0, 100, SIMPLE, LINES], {min: 0, max: 105}],
                '(-100, 100) -> (-105, 105)': [[-100, 100, SIMPLE, LINES], {min: -105, max: 105}],
            },
            'simple line, 10% (custom)': {
                '(50, 1000) -> (45, 1100)': [[50, 1000, SIMPLE_10, LINES], {min: 45, max: 1100}],
                '(0, 100) -> (0, 110)': [[0, 100, SIMPLE_10, LINES], {min: 0, max: 110}],
                '(-100, 100) -> (-110, 110)': [[-100, 100, SIMPLE_10, LINES], {min: -110, max: 110}],
            },
            'area (stacked)': {
